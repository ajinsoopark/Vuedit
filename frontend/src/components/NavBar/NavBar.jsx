...
class NavBar extends Component {
    ...
    componentDidMount () {
        this.props.fetchAllSubvuedits();
    }

    render () {
        const { subvueditList } = this.props.subvuedits ? this.props.subvuedits : '';
        ...
        return (
            <div className='navbar'>
                <div className='homeLink'>
                    <Link className='homeLink' to={ '/' }>
                        <svg className='homeSvg' viewBox="0 0 20 20">
                            <g>
                                <circle className='homeLogo' fill="#185C94" cx="10" cy="10" r="10"></circle>
                                <path fill="#FFF" d="M16.67,10A1.46,1.46,0,0,0,14.2,9a7.12,7.12,0,0,0-3.85-1.23L11,4.65,13.14,5.1a1,1,0,1,0,.13-0.61L10.82,4a0.31,0.31,0,0,0-.37.24L9.71,7.71a7.14,7.14,0,0,0-3.9,1.23A1.46,1.46,0,1,0,4.2,11.33a2.87,2.87,0,0,0,0,.44c0,2.24,2.61,4.06,5.83,4.06s5.83-1.82,5.83-4.06a2.87,2.87,0,0,0,0-.44A1.46,1.46,0,0,0,16.67,10Zm-10,1a1,1,0,1,1,1,1A1,1,0,0,1,6.67,11Zm5.81,2.75a3.84,3.84,0,0,1-2.47.77,3.84,3.84,0,0,1-2.47-.77,0.27,0.27,0,0,1,.38-0.38A3.27,3.27,0,0,0,10,14a3.28,3.28,0,0,0,2.09-.61A0.27,0.27,0,1,1,12.48,13.79Zm-0.18-1.71a1,1,0,1,1,1-1A1,1,0,0,1,12.29,12.08Z"></path>
                            </g>
                        </svg>
                        <svg className='vueditSvg' viewBox="0 0 55 17.44">
                            <g fill="#D7DADC">
                            <circle fill="#185C94" cx="45.77" cy="3.33" r="2.05"></circle>
                            ...
                            <path fill="inherit" d="M7.44,6.32a1.15,1.15,0,0,0-1-1.14A4.46,4.46,0,0,0,2.31,6.69V6.54A1.15,1.15,0,1,0,0,6.54V16a1.18,1.18,0,0,0,1.08,1.2A1.15,1.15,0,0,0,2.31,16V11.15A3.51,3.51,0,0,1,6.15,7.47H6.38A1.15,1.15,0,0,0,7.44,6.32Z"></path>
                            <path fill="inherit" d="M46.92,7.56a1.15,1.15,0,0,0-2.31,0V16a1.15,1.15,0,1,0,2.31,0V7.56Z"></path>
                ...
                <div className='navMenu'>
                    <NavDropdown subvueditList={subvueditList}/>
                </div>
                <div className='navSearch'>
                    <SearchForm />
                </div>
                <div className='sortAndSignUpContainer'>
                    <SortMenu />
