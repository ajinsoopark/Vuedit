...
class CurrentPost extends Component {
    ...
    render () {
        ...
        const { id, comment_count, body, title, created_at, username, sub_name, vote_sum } = this.props.posts.currentPost ? this.props.posts.currentPost : '';
        return (
                                ...
                                <div className='mainLeft'>
                                    <div className='joinSplashDiv'>
                                        ...
                                        <div className='splashContent'>
                                            <svg className='logoSVG' viewBox="0 0 20 20">
                                                <g>
                                            ...
                                            <Link className='splashJoinLink' to={ '' }>
                                                Become a Vuer
                                            </Link>
                                        </div>
                                    </div>
